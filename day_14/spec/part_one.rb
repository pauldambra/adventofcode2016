...
# In order to communicate securely with Santa while you're on
# this mission, you've been using a one-time pad that you generate
# using a pre-agreed algorithm. Unfortunately, you've run out of keys
...
# integer index (starting with 0, and represented in decimal);
# the resulting MD5 hash should be represented as a string of
