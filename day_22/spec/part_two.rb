...
# The node you can access directly, node-x0-y0, is almost full. The node
# containing the data you want to access, node-x2-y0 (because it has y=0
# and the highest x value), contains 6 terabytes of data - enough to fit on
# your node, if only you could make enough space to move it there.
...
describe "day 22 - part two" do
  it "can solve the example grid" do
    input = [
      'Filesystem            Size  Used  Avail  Use%',
      '/dev/grid/node-x0-y0   10T    8T     2T   80%',
      '/dev/grid/node-x0-y1   11T    6T     5T   54%',
