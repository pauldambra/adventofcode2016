...
# their corresponding RTG. An RTG powering a microchip is still dangerous
# to other microchips.
...
describe "day 11 - part one" do
  xit "can count 11 steps for the example input"  do
    facility = InputParser.parse(example_input)
    expect(facility.steps_to_solution).to eq 11
  end
